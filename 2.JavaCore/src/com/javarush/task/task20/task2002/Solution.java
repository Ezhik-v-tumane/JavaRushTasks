...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("your_file_name", ".txt", new File("/Users/sergeymyskov/IdeaProjects/JavaRushTasks/2.JavaCore/src/com/javarush/task/task20/task2002"));
    ...
    public static class JavaRush {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            int usersCount = dataInputStream.readInt();
